...
function BagsContent() {
  ...
  const getProductImage = (name) => {
    ...
    if (
      pName.includes("boorso ciidan") ||
      pName.includes("army bag") ||
      pName.includes("حقيبة الجيش")
    )
      return imageMap["boorso ciidan"];

    if (
      pName.includes("boorso laptop") ||
      pName.includes("laptop bag") ||
      pName.includes("حقيبة كمبيوتر")
    )
      return imageMap["boorso laptop"];
      ...
      <section className="relative h-[420px] flex items-center justify-center bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tight text-white mb-3">
            BAGS <span className="text-[#7047A8] italic font-serif">CARE</span>
          </h1>

          <p className="text-slate-400 text-xs md:text-sm max-w-md mx-auto tracking-wide font-medium opacity-90">
            Premium bags cleaning, sanitizing and professional care for laptop
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-16 bg-[#F3F3F3] rounded-[14px] max-w-md mx-auto">
            <p className="text-slate-400 font-medium">
              No bags services found for this tab.
            </p>
          </div>
        ) : (
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-[11px] text-gray-500 leading-tight">
                      Professional bags cleaning and sanitizing
                    </p>
