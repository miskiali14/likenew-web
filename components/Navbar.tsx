        ...
        >
          {[
            ...
            <Link
              ...
              className="hover:text-purple-600 transition-all relative group"
            >
              {item.label}
          ...
          >
            ...
            <AnimatePresence>
              {showHours && (
                ...
                >
                  <div className="text-[10px] font-black text-purple-600 uppercase mb-4 tracking-widest border-b border-gray-50 pb-2">
                    {t.availability}
                  </div>
                  ...
                  <div className="flex justify-between items-center text-[12px]">
                    ...
                    <span className="font-black text-green-600 px-3 py-1 bg-green-50 rounded-full text-[9px] uppercase">
                      {t.open247}
                    </span>
                  </div>
                </motion.div>
