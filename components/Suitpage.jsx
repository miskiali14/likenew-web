...
function SuitServicesContent() {
  ...
  const processedProducts = useMemo(() => {
    ...
    rawProducts.forEach((prod) => {
      ...
      let finalKey = "other";
      if (pName.includes("futashaari classic")) finalKey = "futashaari classic";
      else if (pName.includes("garabaati") || pName.includes("tie") || pName.includes("كرفته")) finalKey = "garabaati";
      else if (pName.includes("jaakad leather") || pName.includes("leather jacket") || pName.includes("جاكيت جلدي")) finalKey = "jaakad leather";
      else if (pName.includes("jaakad suud") || pName.includes("suit jacket") || pName.includes("جاكيت بدلة")) finalKey = "jaakad suud";
      else if (pName.includes("jaakad caadi") || pName.includes("jacket") || pName.includes("جاكيت")) finalKey = "jaakad caadi";
      else if (pName.includes("mis-jaako") || pName.includes("short blazer") || pName.includes("مشبك بدلة")) finalKey = "mis-jaako";
      else if (pName.includes("suud 2pc") || pName.includes("suit 2pc") || pName.includes("بدلة قطعتين")) finalKey = "suud 2pc";
      else if (pName.includes("suud 3pc") || pName.includes("suit 3pc") || pName.includes("بدلة ثلاث قطع")) finalKey = "suud 3pc";
      ...
      <section className="relative h-[420px] flex items-center justify-center bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tight text-white mb-3">
            SUIT <span className="text-[#7047A8] italic font-serif">CARE</span>
          </h1>

          <p className="text-slate-400 text-xs md:text-sm max-w-md mx-auto tracking-wide font-medium opacity-90">
            Premium formal garment care for suits, jackets, ties and blazers.
          </p>
        </div>
      </section>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-[11px] text-gray-500 leading-tight">
                      Professional formal cleaning and pressing
                    </p>
