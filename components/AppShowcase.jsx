      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 md:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 space-y-8 md:space-y-10 text-center lg:text-left">
            ...
            >
              <span className="inline-flex items-center gap-2 bg-[#825bac]/20 text-[#662d8f] px-4 md:px-5 py-2 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-[0.18em] md:tracking-[0.2em] shadow-sm">
                <Star size={12} fill="currentColor" />
                Download the LikeNew App
              </span>

              <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-gray-900 leading-[0.9] uppercase tracking-tighter">
                Laundry at <br />
              ...
              <p className="text-gray-500 text-sm sm:text-base md:text-lg font-medium max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            {/* FEATURES */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 md:pt-4">
              {features.map((f, i) => (
                <motion.div
                  key={i}
                  ...
                  viewport={{ once: true }}
                  className="p-5 rounded-[1.6rem] md:rounded-[2rem] bg-gray-50 border border-gray-100 text-center hover:bg-white hover:shadow-xl hover:shadow-[#825bac]/10 transition-all duration-500"
                >
                  <div className="mb-4 flex justify-center bg-white w-10 h-10 items-center rounded-xl shadow-sm mx-auto">
                    {f.icon}
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {steps.map((step, i) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative p-6 rounded-[1.6rem] md:rounded-[2rem] bg-white border border-[#825bac]/20 shadow-xl shadow-[#825bac]/10 transition-all duration-500"
                  >
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#662d8f] to-[#825bac] text-white flex items-center justify-center mb-5 shadow-lg shadow-[#825bac]/30 mx-auto sm:mx-0">
                      {step.icon}
                    </div>
            ...
            {/* STORE BUTTONS */}
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4 pt-6 md:pt-8">
              <motion.a
          ...
          {/* RIGHT SIDE */}
          <div className="w-full lg:w-1/2 relative flex justify-center items-center pt-6 lg:pt-0">
