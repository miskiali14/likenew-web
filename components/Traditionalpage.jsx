...
function TraditionalServicesContent() {
  ...
  const processedProducts = useMemo(() => {
    ...
    rawProducts.forEach((prod) => {
      ...
      const isTraditionalItem = targetItems.some((target) =>
      ...
      if (pName.includes("shaati futashaari")) {
        ...
        pName.includes("local suit") ||
        pName.includes("بدلة محلية")
      ) {
        finalKey = "futashaari";
      } else if (
        pName.includes("go/") ||
      ...
      <section className="relative h-[420px] flex items-center justify-center bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <p className="text-slate-400 text-xs md:text-sm max-w-md mx-auto tracking-wide font-medium opacity-90">
            Premium traditional garment care for macawiis, shaal,
            futashaari and local suits.
          </p>
        </div>
      </section>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-[11px] text-gray-500 leading-tight">
                      Professional traditional cleaning and pressing
                    </p>
