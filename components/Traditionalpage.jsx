...
// Khariidadda sawirrada ee alaabta Traditional-ka ah
const imageMap = {
  "futashaari": "/images/classic.png",
  "local suit": "/images/classic.png",
  "بدلة محلية": "/images/classic.png",
  "shaal": "/images/shaal.png",
  "go/": "/images/shaal.png",
  "شال": "/images/shaal.png",
  "macawiis": "/images/macawis.png",
  "sarong": "/images/macawis.png",
  "فوطة": "/images/macawis.png",
  "shaati futashaari": "/images/shaatifutashaari.png",
  "default": "/images/shaatifutashaari.png" 
};
...
export default function TraditionalServicesPage() {
  ...
  const getProductImage = (name) => {
    ...
    // Check strict match first for composite names
    if (pName.includes("shaati futashaari")) {
      return imageMap["shaati futashaari"];
    }
    
    // Check other individual keys
  ...
  const processedProducts = useMemo(() => {
    // Liiska alaabta target-ka ah ee Traditional-ka ah
    const targetItems = [
      "futashaari", "local suit", "بدلة محلية",
      "go/", "shaal", "شال",
      "macawiis", "sarong", "فوطة",
      "shaati futashaari"
    ];
    ...
    rawProducts.forEach(prod => {
      ...
      const isTraditionalItem = targetItems.some(target => pName.includes(target));
      if (!isTraditionalItem) return;
      ...
      let finalKey = "other";
      if (pName.includes("shaati futashaari")) {
        finalKey = "shaati futashaari";
      } else if (pName.includes("futashaari") || pName.includes("local suit") || pName.includes("بدلة محلية")) {
        finalKey = "futashaari";
      } else if (pName.includes("go/") || pName.includes("shaal") || pName.includes("شال")) {
        finalKey = "go/shaal";
      } else if (pName.includes("macawiis") || pName.includes("sarong") || pName.includes("فوطة")) {
        finalKey = "macawiis";
      }
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="text-center">
        ...
        <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-slate-400">Loading Traditional Collection...</p>
      </div>
    </div>
  );
    ...
    <main className="min-h-screen bg-[#FAFAFC]">
      ...
      <section className="relative h-[420px] flex items-center justify-center bg-slate-950 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <motion.img 
            ...
            src="/images/traditional-item.png" 
        ...
        <div className="relative z-20 text-center px-6">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-purple-200">LikeNew Traditional</span>
          </motion.div>
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tight text-white mb-3">
            TRADITIONAL <span className="text-purple-500 italic font-serif">CARE</span>
          </h1>
          <p className="text-slate-400 text-xs md:text-sm max-w-md mx-auto tracking-wide font-medium opacity-90">
            Premium eco-friendly care and premium cleaning tailored for your finest traditional garments.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 -mt-10 relative z-30">
        <div className="bg-white p-2 rounded-3xl shadow-2xl border border-slate-100 flex items-center px-6 group focus-within:ring-4 ring-purple-500/10 transition-all">
          ...
          <input 
            type="text"
            placeholder="Search traditional services..."
