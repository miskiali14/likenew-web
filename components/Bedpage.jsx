...
export default function HomePage() {
  ...
  // Liiska 10-ka shay ee Home Care haddii API xog laga waayo (Fallback Items)
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFC]">
      ...
      {/* Hero Section - Bedcare Design Style */}
      ...
      {/* Search Bar - Bedcare Design Style */}
      ...
      {/* Products Grid - Bedcare Design Style */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <AnimatePresence mode="popLayout">
              {filteredProducts.map((item) => (
                ...
                >
                  <div>
                    {/* Image Container - Bedcare Card Style */}
                  ...
                  {/* Action Button - Bedcare Card Style */}
